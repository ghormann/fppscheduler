...
var handlers = [{
        ...
        callback: function(topic, message) {
            ...
            if (data.status === "GENERATING") {
                datamodel.lastNameGen = moment().toDate();
            }
        }
    },
    {
...
function sendStatus() {
    ...
    let lastNameGen = (ts - datamodel.lastNameGen) / 60000;
    let lastNamePlay = (ts - datamodel.lastNamePlay) / 60000;
    let showRunning = datamodel.isDisplayHours;
