...
module.exports.short_show_list = ["EDM", "Hippo", "Light_of Christmas", "12_Days", "Drummer", "Hot_Chocolate"];
...
module.exports.internal_songs = [{
    ...
    },
    {
        ...
        next: moment().add(10, 'minute').toDate(),
        frequency_min: 10,
        enabled: false
    },
];
...
module.exports.lastSend = moment().toDate();
