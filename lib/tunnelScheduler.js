...
const songs = {
    ...
    Green: ["popcorn.fseq", "Aurora.fseq", "beams.fseq", "Tie_die.fseq", "rainbow.fseq", "Black_Cherry"],
    Red: ["Wings", "Train.fseq"],
    White: ["merry_Christmas.fseq", "Happy_New_Year.fseq"],
    Yellow: ["Sleepy_Rays.fseq", "Warp.fseq", "liquid_fire.fseq", "Circle.fseq", "The_Matrix.fseq"],
};
