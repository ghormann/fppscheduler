...
const songs = {
    Blue: ["Clouds_Sun.fseq", "Christmas_Tree.fseq", "hex_vortax.fseq"],
    Green: ["popcorn.fseq", "Aurora.fseq", "beams.fseq", "Tie_die.fseq"],
    Red: ["Wings", "Train.fseq"],
    White: ["merry_Christmas.fseq", "Happy_New_Year.fseq"],
    Yellow: ["Sleepy_Rays.fseq", "Warp.fseq", "liquid_fire.fseq", "Circle.fseq"],
};
